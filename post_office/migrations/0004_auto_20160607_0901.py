...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='emails',
            field=models.ManyToManyField(related_name='attachments', to=swapper.get_model_name('post_office', 'Email'), verbose_name='Email addresses'),
        ),
        migrations.AlterField(
            model_name='attachment',
            name='file',
        ...
        migrations.AlterField(
            model_name='email',
            name='template',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=swapper.get_model_name('post_office', 'EmailTemplate'), verbose_name='Email template'),
        ),
        migrations.AlterField(
            model_name='emailtemplate',
            name='default_template',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translated_templates', to=swapper.get_model_name('post_office', 'EmailTemplate'), verbose_name='Default template'),
        ),
        migrations.AlterField(
            model_name='emailtemplate',
            name='description',
        ...
        migrations.AlterField(
            model_name='log',
            name='email',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='logs', to=swapper.get_model_name('post_office', 'Email'), verbose_name='Email address'),
        ),
        migrations.AlterField(
            model_name='log',
            name='exception_type',
