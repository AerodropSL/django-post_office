...
class AbstractEmail(models.Model):
    ...
    template = models.ForeignKey(
        swapper.get_model_name('post_office', 'EmailTemplate'), blank=True, null=True,
        verbose_name=_("Email template"), on_delete=models.CASCADE,
    )
...
class AbstractEmailTemplate(models.Model):
    ...
    default_template = models.ForeignKey(
        swapper.get_model_name('post_office', 'EmailTemplate'),
